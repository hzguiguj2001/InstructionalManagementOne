...
<body>
	...
	<form action="${ pageContext.request.contextPath }/student/communicationinfo/update.action" 
		...
		<div class="row">
			<div class="col-sm-5">
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="communicationId" 
								value="${ communicationInfo.communicationId }" 
						...
						<select class="form-control input-sm" name="studentId" >
							...
							<c:forEach items="${studentInfolist}" var="studentInfo">
								<option value="${studentInfo.studentId}" 
										${studentInfo.studentId==communicationInfo.studentId?'selected':'' }>
		...
		<div class="row">
			<div class="col-sm-5">
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="communicationTime" onclick="WdatePicker()" 
								value="<fmt:formatDate value="${communicationInfo.communicationTime}" 
						...
						<select class="form-control input-sm" name="staffId" >
							...
							<c:forEach items="${staffInfolist}" var="staffInfo">
								<option value="${staffInfo.staffId}" 
										${staffInfo.staffId==communicationInfo.staffId?'selected':''}>
									${staffInfo.staffName}
								</option>
							</c:forEach>
						</select>
		...
		<div class="row">
			<div class="col-sm-10">
				<div class="form-group">
					...
					<div class="col-sm-9">
						<textarea class="form-control" name="communicationContent">
							${ communicationInfo.communicationContent }
						</textarea>
					</div>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-sm-3 col-sm-offset-4">
				...
				<a href="${pageContext.request.contextPath }/student/communicationinfo/list.action"
