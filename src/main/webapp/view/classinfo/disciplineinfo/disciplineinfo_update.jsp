...
<form action="${pageContext.request.contextPath }/classinfo/disciplineinfo/update.action" class="form-horizontal">
    ...
    <h5 class="page-header alert-info" style="padding:10px; margin:0px; margin-bottom:5px;">描述</h5>
    	...
    	<div class="col-sm-10">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                	<textarea class="form-control" value="${disciplineInfo.disciplineDesc}" name="disciplineDesc"></textarea>
                </div>
            </div>
        </div>
    </div>
