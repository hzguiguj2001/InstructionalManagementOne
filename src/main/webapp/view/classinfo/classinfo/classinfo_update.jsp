...
<form action="${pageContext.request.contextPath}/classinfo/classinfo/update.action" method="post" class="form-horizontal">
    ...
    <div class="row">
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
               			<input type="text" name="classStartTime" value="${classInfo.classStartTime }" onclick="WdatePicker()" readonly="readonly" class="form-control input-sm" placeholder="请输入开班日期"/>
                </div>
            </div>
        </div>
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
               		 <input type="text" name="classEndTime" value="${classInfo.classEndTime }" onclick="WdatePicker()" readonly="readonly" class="form-control input-sm" placeholder="请输入结束日期"/>
                </div>
            </div>
