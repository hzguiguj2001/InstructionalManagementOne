...
<br/>
	...
	<form
		action="${pageContext.request.contextPath}/payment/studentpayment/update.action"
		class="form-horizontal">
		<div class="row">
			<div class="col-sm-3 col-sm-offset-4">
				<input type="submit" class="btn btn-success" value="保存" /> <input
					type="reset" class="btn  btn-danger" value="取消" /> <a
					href="${pageContext.request.contextPath }/payment/studentpayment/list.action"
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="paymentTime"
							value="<fmt:formatDate value="${studentPayment.paymentTime}" type="both" pattern="yyyy-MM-dd"/>"
